param(
    ...
    [ValidateSet(
        ...
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Event_Remove',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Event_Remove_Relational',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Generic_Remove_After_Event',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Generic_Remove_Relational',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Two_Unlinks',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Ready_Fragment',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Ready_Insert_Relational',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Yield_Fragment',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Yield_Relational',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Next_Head_Read',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Loop_Head_Commit',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Head_TCB_Guard',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Body',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Reentry_Core',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Reentry_Captured_Key',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Reentry_Alignment',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Reentry_Domain_Wake',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Reentry_Generic_Role',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Reentry_Event_Role',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Reentry_Abstract_Snapshot',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Reentry_Observation',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Reentry_Concrete_Shadow',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Reentry_Snapshot',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Reentry_Gate_Phase',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Body_Reentry',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Loop_Induction',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Loop_Pure',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Loop_Capstone',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Replay_Split',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Modular_Endpoint',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Modular_Clear',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Modular_Yield',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Modular_Exit',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Generated_Missed_Loop',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Generated_Outer_Compose',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_After_Drain_Continuation',
        ...
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Outer_Loop_Nested',
        'EAL6_FreeRTOS_V611_Scheduler_Resume_Managed_Outer_Loop_Depth_Zero',
